          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-dsc-surface text-dsc-text shadow-sm border border-dsc-border/50"
                  : "text-dsc-text-secondary hover:bg-dsc-surface/60 hover:text-dsc-text"
              )}
            >
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 lg:hidden p-2 rounded-lg bg-dsc-surface border border-dsc-border shadow-sm"
