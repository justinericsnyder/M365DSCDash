...
export async function GET() {
  ...
  try {
    ...
    const endpoints = [
      ...
      { name: "Teams Apps", path: "/appCatalogs/teamsApps?$top=10", beta: false },
      ...
      { name: "Agent Identities (beta)", path: "/agentRegistry/agentIdentities?$top=10", beta: true },
      { name: "Agent Identities (v1)", path: "/agentRegistry/agentIdentities?$top=10", beta: false },
      { name: "Agent Blueprints (beta)", path: "/agentRegistry/agentIdentityBlueprints?$top=10", beta: true },
      { name: "Agent Blueprints (v1)", path: "/agentRegistry/agentIdentityBlueprints?$top=10", beta: false },
      // Security
